...
- UI 设计已并入本批次：设计规格与交互原型见 [docs/ui-design/cyr2c](../ui-design/cyr2c/README.md)，基于当前产品前端设计系统（`frontend/src/styles.css`）与现有 TasksPage/ChatView 组件；规格先于实现落地，Segment 1 实施前完成评审。
