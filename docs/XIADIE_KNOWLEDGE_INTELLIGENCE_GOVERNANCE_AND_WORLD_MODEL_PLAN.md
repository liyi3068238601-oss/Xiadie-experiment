...
3. docs/archive/legacy-routes/EMOTION_RELATIONSHIP_AND_PROACTIVE_COMPANION_PLAN.md
4. docs/LLM_COGNITIVE_DECISION_REFACTOR_PLAN.md
5. docs/archive/legacy-routes/LLM_DECISION_AND_LIFE_CONTINUITY_PLAN.md
